...
if not _G.Component then _G.Component = require('lib.concord').component end

if not _G.Components then _G.Components = require('lib.concord').components end

if not _G.System then _G.System = require('lib.concord').system end

if not _G.Entity then _G.Entity = require('lib.concord').entity end
